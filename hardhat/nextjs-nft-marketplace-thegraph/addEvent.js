...
const contractAddress = contractAddresses[chainId]['NftMarketplace'][0]; // getting the most recently deployed nft marketplace contract
...
async function main() {
  ...
  if (
    ...
    console.log('Sucess! Database Updated with watching events');
  } else {
